...
(function (factory) {
    ...
    Slick.prototype.setSlideClasses = function (index) {
        ...
        _.$slider.find('.slick-list .slick-active:first').addClass('first-slick').siblings().removeClass('first-slick');
        _.$slider.find('.slick-list .slick-active:last').addClass('last-slick').siblings().removeClass('last-slick');
    };
