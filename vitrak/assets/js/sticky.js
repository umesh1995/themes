(function ($) {
    ...
    window.addEventListener("load", function load() {
         ...
         * </div>
         *
         * @use: $('.sticky-content').ecotech_sticky_sidebar();
         * */
        $.fn.ecotech_sticky_sidebar = function () {
            var $this = $(this);
            if ( $this.closest('.wrapper-main-content').length ) {
                ...
                $this.on('ecotech_sticky_sidebar', function () {
                    $this.each(function () {
                        ...
                        $(window).on('scroll ecotech_load_more_post', function () {
                ...
                }).trigger('ecotech_sticky_sidebar');
        ...
        if ( $('.sticky-content').length ) {
            $('.sticky-content').ecotech_sticky_sidebar();
        }
    }, false);
